...
import compareFaces from "components/compare/compareFace";
import peopleLoad from "components/people/peopleLoad";
import locationLoad from "components/location/locationLoad";
    ...
    const doCapture = () => {
      if (hasPerson && !testing) {
        ...
        if (targets.length !== 0 && address !== "") {
          ...
          compareFaces(client, webcam, targets, address, isTesting, onChange); // Async Function
        } else {
