...
export default async () => {
    ...
    */
    ...
    targets.push({type: 1, key: 32163054, name: "이노원", gender: "남성", age :24, ageNow: 24, clothes: "일상복", poster: bufferSample1})
    targets.push({type: 1, key: 32160462, name: "김도영", gender: "남성", age :25, ageNow: 25, clothes: "일상복", poster: bufferSample2})
